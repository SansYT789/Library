...
if global().vinreachstudio and global().vinreachstudio.ESPLibrary then
   return global().vinreachstudio.ESPLibrary;
end

local __DEBUG = false;
local __LOG = global().environnement and global().environnement == "DEV" or false;
local __PREFIX = "MangoHub ESP"
...
global().vinreachstudio = global().vinreachstudio or { };
global().vinreachstudio.ESPLibrary = Library;
